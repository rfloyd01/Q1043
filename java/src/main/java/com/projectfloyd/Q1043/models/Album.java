...
public class Album {
    ...
    public Album(int id, String title, int releaseYear, int totalTracks, int rankedTracks, String spotifyURI, String albumArtworkURL, double albumScore, Artist artist, String notes, List<Song> songs) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        Album album = (Album) o;
        return id == album.id && releaseYear == album.releaseYear && totalTracks == album.totalTracks && rankedTracks == album.rankedTracks && Objects.equals(title, album.title) && Objects.equals(spotifyURI, album.spotifyURI) && Objects.equals(albumScore, album.albumScore) && Objects.equals(albumArtworkURL, album.albumArtworkURL) && Objects.equals(notes, album.notes) && Objects.equals(artist, album.artist) && Objects.equals(songs, album.songs);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, title, releaseYear, totalTracks, rankedTracks, spotifyURI, albumArtworkURL, albumScore, notes, artist, songs);
    }
